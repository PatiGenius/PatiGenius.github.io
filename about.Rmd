...
knitr::opts_chunk$set(fig.path="C:/Users/patig/OneDrive/Desktop/PatiGenius.github.io")
```
...
```{r, echo=FALSE, fig.cap="Figura 2: Pes de l'atur per districtes a BCN l'any 2019", fig.align='center', render=FALSE}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Figura 7: Rànking dels districtes pel que fa a la taxa d'atur i el preu del lloguer"}
...
```{r, warnings=FALSE, echo=FALSE, fig.cap="Figura 8: Agrupació dels districtes de Barcelona en 3 clústers en funció de 2 paràmetres: atur i lloguer", fig.align='center'}
